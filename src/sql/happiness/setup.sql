REVOKE ALL ON TABLE raw.year_2015 FROM g_readonly;
REVOKE ALL ON TABLE raw.year_2016 FROM g_readonly;
REVOKE ALL ON TABLE raw.year_2017 FROM g_readonly;
REVOKE ALL ON TABLE raw.year_2018 FROM g_readonly;
REVOKE ALL ON TABLE raw.year_2019 FROM g_readonly;
REVOKE ALL ON SCHEMA raw FROM g_happiness_readonly;
REVOKE ALL ON DATABASE happiness FROM g_happiness_readonly;
...
CREATE ROLE happiness_reader WITH
  LOGIN
  NOCREATEROLE
  NOCREATEDB
  ENCRYPTED PASSWORD 'happiness_reader'
  IN GROUP g_happiness_readonly;

CREATE ROLE g_happiness_admin WITH
  NOLOGIN
  NOCREATEDB;
...
CREATE ROLE happiness_admin WITH
  LOGIN
  ENCRYPTED PASSWORD 'happiness_admin'
  CONNECTION LIMIT 1
  IN GROUP g_happiness_admin;
