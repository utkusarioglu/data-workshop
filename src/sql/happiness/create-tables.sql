...
\i '/migrations/happiness/migrate-2015.sql';
CALL migrate_year_2015();

CALL create_2016_tables();
\i '/migrations/happiness/migrate-2016.sql';
CALL migrate_year_2016();

CALL create_2017_tables();
\i '/migrations/happiness/migrate-2017.sql';
CALL migrate_year_2017();

CALL create_2018_tables();
\i '/migrations/happiness/migrate-2018.sql';
CALL migrate_year_2018();

CALL create_2019_tables();
\i '/migrations/happiness/migrate-2019.sql';
